...
/**
 * Class for Specific Time Power Consumption sensor
 */
public class SpecificTimePowerConsumptionSensor extends Sensor {
     ...
     */
    protected SpecificTimePowerConsumptionSensor (
            SensorID sensorName,
            DeviceID deviceID,
